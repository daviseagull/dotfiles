  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      MiniStatusline.section_filename = function()
        local filename = vim.fn.expand '%:t' -- Just the filename, not the path
        if filename == '' then
          filename = '[scratch]'
        end
      ...
      -- Override the entire statusline for Helix-like appearance
      ---@diagnostic disable-next-line: duplicate-set-field
      MiniStatusline.active = function()
        ...
        return MiniStatusline.combine_groups {
          ...
          { hl = 'MiniStatuslineInactive', strings = { '' } }, -- Reset highlight
          '%=', -- Center alignment
